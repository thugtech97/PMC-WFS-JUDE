...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'password', 'department', 'dept_id', 'designation', 'role', 'isActive', 'remember_token', 'username', 'email', 'user_type', 'condition', 'section', 'division', 'isdynamic', 'is_dynamic', 'position'
    ];
