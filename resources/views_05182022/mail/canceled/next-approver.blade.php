...
<div style="max-width: 700px; width: 100%; background: #fff;margin: 30px auto;">
    ...
    <div style="padding:30px 60px;">
        ...
        <p style="margin-top: 30px;"><strong>Dear {{ $requestor->requestor }},</strong></p>

        <p>Good day!</p>

        <p>Please be informed that your request <strong>{{ $requestor->transid }}</strong> has been denied and cancelled by  {{ $onholdby->designation }}.</p>
