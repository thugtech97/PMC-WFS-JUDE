            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane show active" id="last-month" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row mt-20">
                                ...
                                <div class="col-md-3 col-6"> <strong>Amount</strong>
                                    <br>
                                    <p class="text-muted">{{ $data->currency }} {{ number_format($data->totalamount,2) }}</p>
                                </div>
                                 <div class="col-md-6 col-6"> <strong>Payee Name</strong>
                                    <br>
                                    <p class="text-muted">{{ $data->name }}</p>
                                </div>                                 
                            </div>
                            <div class="row mt-20">
                                 <div class="col-md-6 col-6"> <strong>Purpose</strong>
                                    <br>
                        ...
                        <div class="alert alert-info">To view the whole transaction details. Please click this <a href="{{$data->source_url}}" target="_blank" class="text-blue"><span style="font-size: 19px; font-weight: bold;">link</span></a>.</div>                        
                        <hr>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <form class="forms-sample">
                                                    @csrf
                                                     <div class="form-group" @if($approverstatus->remarks==NULL || $approverstatus->remarks=='') style="display:none;" @endif>
                                                        <label for="exampleTextarea1">Old Remarks</label>
                                                        <textarea class="form-control" id="oldremarks" rows="4" readonly>{{ $approverstatus->remarks }} ({{ $approverstatus->updated_at }})</textarea>                  
                                                    </div>
                                                    <div class="form-group">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <form class="forms-sample">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label for="exampleTextarea1" @if($approverstatus->remarks==NULL || $approverstatus->remarks=='') style="display:none;" @endif>Old Remarks</label>
                                                        <textarea class="form-control" id="oldremarks" rows="4" readonly>{{ $approverstatus->remarks }} ({{ $approverstatus->updated_at }})</textarea>                  
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleTextarea1">Remarks</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <form class="forms-sample">
                                                    @csrf
                                                    <div class="form-group" @if($currentuser->status=='PENDING' || $approverstatus->remarks==NULL || $approverstatus->remarks=='') style="display: none" @endif>
                                                        <label for="exampleTextarea1">Old Remarks</label>
                                                        <textarea class="form-control" id="oldremarks" rows="4" readonly>{{ $approverstatus->remarks }} ({{ $approverstatus->updated_at }})</textarea>                  
                                                    </div>
                                                    <div class="form-group">
